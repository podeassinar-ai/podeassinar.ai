    ...
    <aside className="hidden md:flex fixed left-0 top-0 h-screen w-64 bg-white border-r border-border flex-col shadow-lg z-50">
      <div className="p-8">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div>
            ...
            <span className="text-[10px] text-text-muted font-bold uppercase tracking-widest">Inteligência</span>
          </div>
        </Link>
      </div>
      ...
      <div className="p-6 border-t border-border">
        <div className="flex items-center gap-3 px-3 py-3 rounded-xl bg-gray-50 border border-border/50 hover:bg-orange-50/50 hover:border-primary/20 transition-all cursor-pointer">
          <div className="w-9 h-9 bg-white rounded-lg flex items-center justify-center text-primary font-bold shadow-sm border border-border">
            US
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold text-text-primary truncate">Usuário</p>
            <p className="text-xs text-text-muted truncate">usuario@email.com</p>
          </div>
        </div>
      </div>
    </aside>
